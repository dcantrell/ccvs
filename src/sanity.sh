...
"${PROG} update: Updating \.
${PROG} update: Updating first-dir
${PROG} update: failed to create lock directory for \`$CVSROOT_DIRNAME/first-dir' ($CVSROOT_DIRNAME/first-dir/#cvs.lock): Permission denied
${PROG} update: failed to obtain dir lock in repository \`$CVSROOT_DIRNAME/first-dir'
${PROG} \[update aborted\]: read lock failed - giving up"
	    fi
	  else
