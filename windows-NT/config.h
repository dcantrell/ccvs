...
/* Define if you want CVS to attempt to second-guess the system file cacne. On
   some systems, disabling this option may provide a performance boost, but on
   most modern operating systems it probably won't. If you find a system where
   this option improves CVS's performance, please send a note describing it to
   the <bug-cvs@gnu.org> mailing list. */
#undef TRUST_OS_FILE_CACHE
